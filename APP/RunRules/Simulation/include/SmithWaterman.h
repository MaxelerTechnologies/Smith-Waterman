...
#define SmithWaterman_PCIE_ALIGNMENT (16)
 ...
 * \param [in] lmem_address_inS Linear LMem control for "inS" stream: base address, in bytes.
 * \param [in] lmem_arr_size_inS Linear LMem control for "inS" stream: array size, in bytes.
 * \param [in] lmem_address_inhflag Linear LMem control for "inhflag" stream: base address, in bytes.
 * \param [in] lmem_arr_size_inhflag Linear LMem control for "inhflag" stream: array size, in bytes.
...
typedef struct { 
	...
	size_t lmem_address_inS; /**<  [in] Linear LMem control for "inS" stream: base address, in bytes. */
	size_t lmem_arr_size_inS; /**<  [in] Linear LMem control for "inS" stream: array size, in bytes. */
	size_t lmem_address_inhflag; /**<  [in] Linear LMem control for "inhflag" stream: base address, in bytes. */
	size_t lmem_arr_size_inhflag; /**<  [in] Linear LMem control for "inhflag" stream: array size, in bytes. */
...
void SmithWaterman_clear_errors(void);
/* Free statically allocated maxfile data */
void SmithWaterman_free(void);
/* returns: -1 = error running command; 0 = no error reported */
int SmithWaterman_simulator_start(void);
/* returns: -1 = error running command; 0 = no error reported */
int SmithWaterman_simulator_stop(void);
